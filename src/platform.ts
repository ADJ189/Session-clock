...
// recorded ambient sound tracks ship in. Chrome/Firefox/Edge have decoded
// Ogg Opus for years; Safari/WebKit only gained it in Safari 17 (macOS
// Sonoma / iOS 17, both 2023), and there's no reliable UA signal for that
// version gap, so this asks the engine directly instead of guessing.
